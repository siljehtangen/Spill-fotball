...
window.alert("Før dere starter legg inn navn!");
let init = requestAnimationFrame(start);
let player1 = new Player(100,250);
let playernavn =  window.prompt("Hva heter spiller1 (rød)?");
let player2 = new Player(600,250); 
let player2navn =  window.prompt("Hva heter spiller2 (blå)?"); 
let ball = new Ball(350,250);
let wDown = false;
let sDown = false;
let aDown = false;
let dDown = false;
...
function start(){
    ...
    <section>
    <div>
    <p> <strong> ${playernavn}</strong>:${player1.score} </p>
    </div> 
    <div>
    <p> <strong> ${player2navn}</strong>:${player2.score} </p>
    </div>
    </section> `;
...
let btnManu = document.getElementById("Manu");
let btnLiverpool = document.getElementById("Liverpool");
let btnMancity = document.getElementById("Mancity");
let btnChelsea = document.getElementById("Chelsea")
...
btnLiverpool.onclick = () => {
    bilde.src = "liverpool.png"
}

btnMancity.onclick = () => {
    bilde2.src = "mancity.png"
}

btnChelsea.onclick = () => {
    bilde2.src = "chelsea.png"
}